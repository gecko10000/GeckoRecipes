...
class ShapelessRecipeGUI(player: Player, private val recipe: ShapelessCustomRecipe) : GUI(player), KoinComponent {
    ...
    override fun createInventory(): InventoryGUI {
        ...
        recipe.ingredients.map { guiComponents.recipeChoiceButton(player, it) { ShapelessRecipeGUI(player, recipe) } }
